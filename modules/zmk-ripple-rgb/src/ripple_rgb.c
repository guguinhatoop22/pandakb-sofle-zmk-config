...
#include <zmk_ripple_rgb/ripple_rgb.h>
...
#ifndef CONFIG_ZMK_RIPPLE_RGB_PEAK_BRIGHTNESS
#define CONFIG_ZMK_RIPPLE_RGB_PEAK_BRIGHTNESS 35
#endif

#ifndef CONFIG_ZMK_RIPPLE_RGB_DURATION_MS
#define CONFIG_ZMK_RIPPLE_RGB_DURATION_MS 800
#endif

#ifndef CONFIG_ZMK_RIPPLE_RGB_FPS
#define CONFIG_ZMK_RIPPLE_RGB_FPS 25
#endif
...
static void ripple_work_handler(struct k_work *work) {
    ...
    uint32_t frame_interval_ms = 1000 / CONFIG_ZMK_RIPPLE_RGB_FPS;
