...
#elif IS_ENABLED(CONFIG_NICE_OLED_WIDGET_STATIC_IMAGE_PERIPHERAL_GUGUINHATOP)
LV_IMG_DECLARE(guguinhatop);
#define FIXED_IMAGE_GUGUINHATOP &guguinhatop
...
#elif IS_ENABLED(CONFIG_NICE_OLED_WIDGET_STATIC_IMAGE_PERIPHERAL_GUGUINHATOP)
    lv_img_set_src(art, FIXED_IMAGE_GUGUINHATOP);
#else
